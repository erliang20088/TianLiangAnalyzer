...
//										.getBranch(ComplexToSimpleManager
//												.convert(content.charAt(begin)))) != null)
//								&& (temp_branch.getWordType() == WordPojoType.NUMBER || temp_branch
//										.getWordType() == WordPojoType.ALPHA)) {
//							end++;
...
//										.getWordType() || temp_branch
//										.getWordType() == WordPojoType.NUMBER)) {
//							end++;
//							temp_branch = this.forest.getBranch(content
//									.charAt(begin));
//						}
